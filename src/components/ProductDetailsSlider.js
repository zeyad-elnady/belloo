      ...
      >
        <div className="product-img">
          <a
            ...
            className="img-popup"
          >
            <img src="/assets/images/products/product-big-1.jpg" alt="Product" />
          </a>
        </div>
        <div className="product-img">
          <a
            ...
            className="img-popup"
          >
            <img src="/assets/images/products/product-big-2.jpg" alt="Product" />
          </a>
        </div>
        <div className="product-img">
          <a
            ...
            className="img-popup"
          >
            <img src="/assets/images/products/product-big-3.jpg" alt="Product" />
          </a>
        </div>
      </Slider>
      <Slider
